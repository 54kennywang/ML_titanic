...
tune_results = model_selection.cross_validate(tune_model, data1[data1_x_bin], data1[Target], cv  = cv_split, return_train_score=True)
print('AFTER DT Parameters: ', tune_model.best_params_)
...
print(type(graph))
graph.format = 'png'
graph.render('output/dtree_render', view=True)
"""
